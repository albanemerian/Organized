...
{
    my_printf("Hello your age is %d.", 23);
...
Test(mini_printevery, string_char, .init = redirect_all_std)
{
    ...
    my_printf("If you leave %s at %d years old you spent %i years of your life there.", str, bn, my_strlen(str));
...
{
    my_printf("Staying alive is %s, and great %.", "fun");
...
{
    my_printf("The octal value of o %o.", 244);
...
Test(mini_printuu, string_char, .init = redirect_all_std)
{
    ...
    my_printf("The absolute value of %u.", nb);
...
Test(mini_printuaze, string_char, .init = redirect_all_std)
{
    ...
    my_printf("The absolute value of %u.", bn);
...
Test(mini_printupperneg, string_char, .init = redirect_all_std)
{
    ...
    my_printf("The value upper of a negative is %F.", r);
    cr_assert_stdout_eq_str("The value upper of a negative is -10.130000.");
}


Test(my_printflowz, string_char, .init = redirect_all_std)
{
    my_printf("The value is %f.", 214748.31);
...
{
    my_printf("The limit %f, %F.", -21474836.478, -21474836.478);
    cr_assert_stdout_eq_str("The limit -21474836.478000, -21474836.478000.");
}

Test(my_printund, string_char, .init = redirect_all_std)
{
    my_printf("%f %F.", -456861114.1111516, -456861114.1111516);
    cr_assert_stdout_eq_str("-456861114.111152 -456861114.111152.");
}
Test(my_printfnull, string_char, .init = redirect_all_std)
{
    my_printf("%f %F", -42, -42);
    cr_assert_stdout_eq_str("0.000000 0.000000");
}

Test(my_printfthth, string_char, .init = redirect_all_std)
{
    my_printf("%f %F", 0.913, 0.913);
    cr_assert_stdout_eq_str("0.913000 0.913000");
}

Test(my_printfzefi, string_char, .init = redirect_all_std)
{
    my_printf("%f %F", 42.05, 42.05);
    cr_assert_stdout_eq_str("42.050000 42.050000");
}

Test(my_printfcroh, string_char, .init = redirect_all_std)
{
    my_printf("%#o", 23);
...
Test(my_printfcroom, string_char, .init = redirect_all_std)
{
    my_printf("%#X", 23);
    cr_assert_stdout_eq_str("0X17");
}

Test(my_printfcrou, string_char, .init = redirect_all_std)
{
    my_printf("%#d", 34);
    cr_assert_stdout_eq_str("34");
}

Test(my_printfcrod, string_char, .init = redirect_all_std)
{
    my_printf("%#f %#F", 23.435, 23.435);
    cr_assert_stdout_eq_str("23.435000 23.435000");
}

Test(my_printfcrs, string_char, .init = redirect_all_std)
{
    my_printf("%#s", "epitech");
    cr_assert_stdout_eq_str("epitech");
}

Test(my_printfcrc, string_char, .init = redirect_all_std)
{
    char i ='a';
...
Test(my_printfcru, string_char, .init = redirect_all_std)
{
...
Test(my_printfcris, string_char, .init = redirect_all_std)
{
    char str [8] = "Ronflex";
...
Test(my_printfcrmod, string_char, .init = redirect_all_std)
{
    my_printf("The value %#%%s%% is fun.", "world");
...
Test ( my_strcat, test_strcat)
{
    ...
    cr_assert_str_eq(my_strcat(dest, "Hello"),strcat(dest, "Hello"));
}
