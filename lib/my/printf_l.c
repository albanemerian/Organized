...
static int flag_medium(const char *format,
...
static int flag_base(const char *format,
    va_list param_infos, int i, int compt)
{
        flag_medium(format, param_infos, i, compt);
}

static int flag_simple(const char *format,
    va_list param_infos, int i, int compt)
{
...
static int other_flagsi(const char *format,
    va_list param_infos, int i, int compt)
{
...
static int other_flag(const char *format,
    va_list param_infos, int i, int compt)
{
    unsigned long int rbn = va_arg(param_infos, unsigned long int);
    unsigned long rb = va_arg(param_infos, unsigned long);
...
int other_flags(const char *format,
    va_list param_infos, int i, int compt)
{
    unsigned long int bn = va_arg(param_infos, unsigned long int);
    unsigned long int nbr = va_arg(param_infos, unsigned long int);
